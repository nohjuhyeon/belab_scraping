...
try:
    ...
    ai_df = notice_df.loc[notice_df['비고'].str.contains('인공지능')]  # '비고' 컬럼에서 '인공지능' 포함 데이터 필터링
    ...
    data_df = notice_df.loc[notice_df['비고'].str.contains('데이터')]  # '비고' 컬럼에서 '데이터' 포함 데이터 필터링
    ...
    cloud_df = notice_df.loc[notice_df['비고'].str.contains('클라우드')]  # '비고' 컬럼에서 '클라우드' 포함 데이터 필터링
    ...
    isp_df = notice_df.loc[notice_df['비고'].str.contains('ISP/ISMP')]  # '비고' 컬럼에서 'ISP/ISMP' 포함 데이터 필터링
    ...
    isp_cloud_df = notice_df.loc[
        (notice_df['비고'].str.contains('ISP/ISMP')) | (notice_df['비고'].str.contains('클라우드'))
